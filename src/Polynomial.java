/**
 * @author          Annie Wu
 * Assignment:      Program 3 - Interpolating Polynomials
 *
 * Class:           CS 3010 - Numerical Methods
 * Date:            10 May 2019
 *
 * Purpose:         This class creates a simplified linear polynomial.
 *
 */
...
public class Polynomial {
    ...
    /**
     * Constructor that forms tha polynomial as ax^b, where a is the coefficients and b is the degree.
     * @param coefficients
     * @param degree
     */
    ...
    /**
     * Add poly to the given polynomial.
     * @param poly The polynomial you are adding
     ...
     * @param poly The polynomial you want to multiply
     ...
     * @param constant Value to multiply the polynomial by
