 ...
 * Date:            10 May 2019
 *
 * Purpose:         This is the main class to run the program.
 *                  It will ask the user for a file name, load the data from the file, and print the divided
 *                  differences table and the unsimplified and simplified polynomials in Newton's and Lagrange's form.
 *
 */
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Annie Wu's Polynomial Interpolation Program has ended.");
    }
}
